...
> 🚀 **نسخة مباشرة:** <https://mahamuk.pages.dev/>
...
تطبيقات أخرى لنفس المطوّر:

- **مهامك (Mahamuk)** — هذا المشروع: <https://mahamuk.pages.dev>
- كل التطبيقات الأخرى: <https://zinedev.pages.dev>
